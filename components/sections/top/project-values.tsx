      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            {
              title: "世界、未来との関係の再構築ーあなたの人生に意味をあたえる物",
                //"美ーわたしたちの生きる道標",
              description: "あなたの参加を通じて、自分が世界の多様な存在とともに生きともに未来を生み出していることを感じることができます。空神楽を通じて多様な人、お金/スマホといった人工物、空気/植物といった自然物と生きる物語を編み直します。",
